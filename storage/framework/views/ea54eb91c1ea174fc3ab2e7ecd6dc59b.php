...
<div>
    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6 mb-8">
        <div>
            <div class="flex items-center gap-4">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($material_id || $startDate || $endDate || $search || $type != ''): ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($material_id): ?>
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8 animate-fade-in">
        <div class="bg-white p-6 rounded-[2rem] shadow-sm border border-warm/60 relative overflow-hidden group hover:shadow-md transition-all">
            ...
            <div class="flex items-baseline gap-1">
                <span class="text-2xl font-black text-gray-900"><?php echo e(number_format($openingBalance, 0, ',', '.')); ?></span>
                <span class="text-[10px] font-bold text-gray-400 uppercase"><?php echo e($selectedMaterial->unit ?? ''); ?></span>
            </div>
            <p class="text-[9px] text-gray-400 mt-2 font-medium">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($startDate): ?>
                    Per tanggal <?php echo e(Carbon::parse($startDate)->format('d/m/Y')); ?>
        ...
        <div class="bg-emerald-50/50 p-6 rounded-[2rem] shadow-sm border border-emerald-100 relative overflow-hidden group hover:shadow-md transition-all">
            ...
            <div class="flex items-baseline gap-1">
                <span class="text-2xl font-black text-emerald-700"><?php echo e(number_format($totalIn, 0, ',', '.')); ?></span>
                <span class="text-[10px] font-bold text-emerald-600/40 uppercase"><?php echo e($selectedMaterial->unit ?? ''); ?></span>
            </div>
        ...
        <div class="bg-red-50/50 p-6 rounded-[2rem] shadow-sm border border-red-100 relative overflow-hidden group hover:shadow-md transition-all">
            ...
            <div class="flex items-baseline gap-1">
                <span class="text-2xl font-black text-red-700"><?php echo e(number_format($totalOut, 0, ',', '.')); ?></span>
                <span class="text-[10px] font-bold text-red-600/40 uppercase"><?php echo e($selectedMaterial->unit ?? ''); ?></span>
            </div>
        ...
        <div class="bg-accent p-6 rounded-[2rem] shadow-lg shadow-accent/20 relative overflow-hidden group hover:shadow-xl transition-all">
            ...
            <div class="flex items-baseline gap-1">
                <span class="text-2xl font-black text-white"><?php echo e(number_format($finalBalance, 0, ',', '.')); ?></span>
                <span class="text-[10px] font-bold text-white/60 uppercase"><?php echo e($selectedMaterial->unit ?? ''); ?></span>
            </div>
        ...
        <div class="overflow-x-auto scrollbar-thin scrollbar-thumb-warm scrollbar-track-base">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-warm/40">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($material_id && $reportData->onFirstPage()): ?>
                    <tr class="bg-blue-50/10 font-bold italic">
                        ...
                        <td class="px-6 py-4 text-center text-gray-400 font-bold text-[10px] uppercase"><?php echo e($selectedMaterial->unit ?? ''); ?></td>
                    ...
                    <tr class="hover:bg-base/40 transition-colors group">
                        <td class="px-6 py-4 text-gray-600 whitespace-nowrap font-medium"><?php echo e($trx->created_at->format('d/m/Y H:i')); ?></td>
                        <td class="px-6 py-4 font-mono text-[11px] font-black text-accent uppercase tracking-tight">
                            <?php echo e($trx->reference_number ?: '-'); ?>

                        </td>
                        <td class="px-6 py-4 font-black text-gray-800"><?php echo e($trx->material->name); ?></td>
                        ...
                        <td class="px-6 py-4 text-center text-gray-500 font-bold text-[10px] uppercase"><?php echo e($trx->material->unit); ?></td>
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex justify-end opacity-0 group-hover:opacity-100 transition-opacity">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($trx->delivery_order_id): ?>
                                    <button wire:click="$dispatch('show-sj-detail', { id: <?php echo e($trx->delivery_order_id); ?> })" class="inline-flex items-center gap-2 px-4 py-2 bg-accent/5 hover:bg-accent text-accent hover:text-white rounded-xl text-[10px] font-black uppercase transition-all shadow-sm active:scale-95">
                                ...
                                <?php else: ?>
                                    <button wire:click="$dispatch('show-trx-detail', { id: <?php echo e($trx->id); ?> })" class="inline-flex items-center gap-2 px-4 py-2 bg-emerald-50 hover:bg-emerald-600 text-emerald-600 hover:text-white rounded-xl text-[10px] font-black uppercase transition-all shadow-sm active:scale-95">
                                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div id="print-area" class="hidden print-target bg-white text-black text-xs" style="font-family: 'Times New Roman', serif;">
        ...
        <div class="text-center mb-8">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedMaterial): ?>
                <p class="text-lg font-bold mt-1 uppercase"><?php echo e($selectedMaterial->name); ?></p>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <p class="text-sm mt-1">Periode: <?php echo e($startDate ? Carbon::parse($startDate)->format('d/m/Y') : '-'); ?> s/d <?php echo e($endDate ? Carbon::parse($endDate)->format('d/m/Y') : Carbon::now()->format('d/m/Y')); ?></p>
        </div>
        ...
        <div class="mb-8">
            ...
            <table class="w-full border-collapse border border-black text-[9px]">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $materialsSummary; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $summary): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="border border-black px-2 py-1 text-center"><?php echo e($index + 1); ?></td>
                        <td class="border border-black px-2 py-1 font-bold"><?php echo e($summary->name); ?></td>
                        <td class="border border-black px-2 py-1 text-center uppercase"><?php echo e($summary->unit); ?></td>
                        <td class="border border-black px-2 py-1 text-right"><?php echo e(number_format($summary->opening, 0, ',', '.')); ?></td>
                        <td class="border border-black px-2 py-1 text-right text-emerald-700 font-bold"><?php echo e(number_format($summary->in, 0, ',', '.')); ?></td>
                        <td class="border border-black px-2 py-1 text-right text-red-700 font-bold"><?php echo e(number_format($summary->out, 0, ',', '.')); ?></td>
                        <td class="border border-black px-2 py-1 text-right font-black bg-gray-50"><?php echo e(number_format($summary->final, 0, ',', '.')); ?></td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </tbody>
            </table>
            ...
            <table class="w-full border-collapse border border-black">
                ...
                <tbody>
                    ...
                    <tr class="bg-gray-50 font-bold">
                        ...
                        <td class="border border-black px-2 py-1.5 uppercase"><?php echo e($selectedMaterial->name); ?></td>
                        ...
                        <td class="border border-black px-2 py-1.5 text-right">-</td>
                        <td class="border border-black px-2 py-1.5 text-right font-black"><?php echo e(number_format($openingBalance, 0, ',', '.')); ?></td>
                    </tr>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $reportData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $trx): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="border border-black px-2 py-1.5 text-center"><?php echo e($index + 1); ?></td>
                        <td class="border border-black px-2 py-1.5"><?php echo e($trx->created_at->format('d/m/Y')); ?></td>
                        <td class="border border-black px-2 py-1.5 font-mono text-[8px] uppercase"><?php echo e($trx->reference_number ?: '-'); ?></td>
                        <td class="border border-black px-2 py-1.5 font-bold text-[8px] uppercase"><?php echo e($trx->material->name); ?></td>
                        <td class="border border-black px-2 py-1.5 text-[8px]">
                            <?php echo e($trx->deliveryOrder->lokasi ?? ($trx->supplier ?: ($trx->description ?: 'Mutasi Stok'))); ?>

                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($trx->deliveryOrder && $trx->deliveryOrder->no_polisi): ?>
                                (<?php echo e($trx->deliveryOrder->no_polisi); ?>)
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </td>
        ...
        <div class="mt-12 flex justify-end pr-8">
            <div class="text-center w-64">
                <p class="text-sm">Jakarta, <?php echo e(Carbon::now()->translatedFormat('d F Y')); ?></p>
                <p class="text-sm font-bold mt-1">Petugas Gudang / Admin,</p>
                <div class="h-24"></div>
                <p class="text-sm font-bold underline uppercase"><?php echo e(auth()->user()->name); ?></p>
            </div>
        </div>
    </div>
    ...
    <script>
        window.printReport = function() {
            ...
            const materialName = "<?php echo e($selectedMaterial->name ?? 'Inventory'); ?>";
