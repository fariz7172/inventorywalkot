...
<div>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-warm/40">
                    ...
                    <tr class="bg-blue-50/10 font-bold italic">
                        ...
                        <td class="px-4 py-3 text-center text-gray-400 font-bold text-[10px] uppercase"><?php echo e($selectedMaterial->unit ?? ''); ?></td>
                    ...
                    <tr class="hover:bg-base/40 transition-colors group">
                        <td class="px-4 py-3 text-gray-600 whitespace-nowrap font-medium"><?php echo e($trx->created_at->format('d/m/Y H:i')); ?></td>
                        <td class="px-4 py-3 font-mono text-[11px] font-black text-accent uppercase tracking-tight">
                            <?php echo e($trx->reference_number ?: '-'); ?>

                        </td>
                        <td class="px-4 py-3 font-black text-gray-800"><?php echo e($trx->material->name); ?></td>
                        ...
                        <td class="px-4 py-3 text-right">
                            <div class="flex justify-end opacity-0 group-hover:opacity-100 transition-opacity">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($trx->delivery_order_id): ?>
                                    <button wire:click="$dispatch('show-sj-detail', { id: <?php echo e($trx->delivery_order_id); ?> })" class="inline-flex items-center gap-2 px-3 py-1.5 bg-accent/5 hover:bg-accent text-accent hover:text-white rounded-xl text-[10px] font-black uppercase transition-all shadow-sm active:scale-95">
                                ...
                                <?php else: ?>
                                    <button wire:click="$dispatch('show-trx-detail', { id: <?php echo e($trx->id); ?> })" class="inline-flex items-center gap-2 px-3 py-1.5 bg-emerald-50 hover:bg-emerald-600 text-emerald-600 hover:text-white rounded-xl text-[10px] font-black uppercase transition-all shadow-sm active:scale-95">
                                        <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <script>
        window.printReport = function() {
            ...
            const materialName = "<?php echo e($selectedMaterial->name ?? ''); ?>";
